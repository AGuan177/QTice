...
{
    ui->widget->setStyleSheet("background-color:"+ChangeColor_Window::icebreak+";"+ "border:none;");
...
{
    ui->widget->setStyleSheet("background-color:"+ChangeColor_Window::macaroon+";"+ "border:none;");
    emit sig_color(ChangeColor_Window::macaroon);
}

void ChangeColor_Window::on_morandi_clicked()
{
    ui->widget->setStyleSheet("background-color:"+ChangeColor_Window::morandi+";"+ "border:none;");
    emit sig_color(ChangeColor_Window::morandi);
}

void ChangeColor_Window::on_red_clicked()
{
    ui->widget->setStyleSheet("background-color:"+ChangeColor_Window::red+";"+ "border:none;");
    emit sig_color(ChangeColor_Window::red);
}

void ChangeColor_Window::on_yellow_clicked()
{
    ui->widget->setStyleSheet("background-color:"+ChangeColor_Window::yellow+";"+ "border:none;");
    emit sig_color(ChangeColor_Window::yellow);
}

void ChangeColor_Window::on_green_clicked()
{
    ui->widget->setStyleSheet("background-color:"+ChangeColor_Window::green+";"+ "border:none;");
    emit sig_color(ChangeColor_Window::green);
}

void ChangeColor_Window::on_pink_clicked()
{
    ui->widget->setStyleSheet("background-color:"+ChangeColor_Window::pink+";"+ "border:none;");
    emit sig_color(ChangeColor_Window::pink);
}

void ChangeColor_Window::on_orange_clicked()
{
    ui->widget->setStyleSheet("background-color:"+ChangeColor_Window::orange+";"+ "border:none;");
    emit sig_color(ChangeColor_Window::orange);
}

void ChangeColor_Window::on_purple_clicked()
{
    ui->widget->setStyleSheet("background-color:"+ChangeColor_Window::purple+";"+ "border:none;");
