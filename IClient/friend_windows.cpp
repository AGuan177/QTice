    ...
    ui(new Ui::Friend_Windows),tcpSocket(tcpsocket)
{
    ...
    QString color = "#A5DEE4#51A8DD#2EA9DF";
    QString color_light = color.mid(0, 7);
    QString color_medium = color.mid(7, 7);
    QString color_hard = color.mid(14, 7);

    ui->listWidgetFriend->setStyleSheet("border:none;""background-color:"+color_light+";");
    ui->listWidgetGroup->setStyleSheet("border:none;""background-color:"+color_light+";");
    ui->tabWidget->setStyleSheet("border:none");
    ui->labelID->setStyleSheet("background:rgba(225,225,225,0);""font: 75 12pt \"Agency FB\";");
