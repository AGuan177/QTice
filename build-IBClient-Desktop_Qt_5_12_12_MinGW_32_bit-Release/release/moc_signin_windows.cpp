...
#include "../../IBClient/signin_windows.h"
...
void Signin_Windows::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<Signin_Windows *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (Signin_Windows::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Signin_Windows::sig_clickRegster)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject Signin_Windows::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_Signin_Windows.data,
    qt_meta_data_Signin_Windows,
    qt_static_metacall,
    nullptr,
    nullptr
} };
