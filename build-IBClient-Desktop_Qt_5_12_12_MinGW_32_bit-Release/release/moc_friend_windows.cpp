...
#include "../../IBClient/friend_windows.h"
...
void Friend_Windows::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<Friend_Windows *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (Friend_Windows::*)(Chat_windows * , QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Friend_Windows::select_friend)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Friend_Windows::*)(Groupchat_windows * , QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Friend_Windows::select_group)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (Friend_Windows::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Friend_Windows::sig_clickAdd)) {
                *result = 2;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject Friend_Windows::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_Friend_Windows.data,
    qt_meta_data_Friend_Windows,
    qt_static_metacall,
    nullptr,
    nullptr
} };
