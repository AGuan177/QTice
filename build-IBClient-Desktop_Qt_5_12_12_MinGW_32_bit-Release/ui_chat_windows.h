...
"}"));
        ...
        send_img->setObjectName(QString::fromUtf8("send_img"));
        send_img->setMinimumSize(QSize(50, 50));
        send_img->setMaximumSize(QSize(50, 50));
        send_img->setStyleSheet(QString::fromUtf8("QPushButton#send_img{\n"
"border:none;\n"
"}\n"
...
"}"));
        ...
        prtsc->setStyleSheet(QString::fromUtf8("QPushButton#prtsc{\n"
"border:none;\n"
"}\n"
...
"left-margin: 10px;"));
    ...
    {
        Chat_windows->setWindowTitle(QApplication::translate("Chat_windows", "Form", nullptr));
        emoji->setText(QString());
        send_file->setText(QString());
        send_img->setText(QString());
        prtsc->setText(QString());
        Send->setText(QApplication::translate("Chat_windows", "\345\217\221\351\200\201", nullptr));
#ifndef QT_NO_SHORTCUT
        Send->setShortcut(QApplication::translate("Chat_windows", "Return", nullptr));
