...
public:
    ...
    void setupUi(QWidget *Groupchat_windows)
    {
        if (Groupchat_windows->objectName().isEmpty())
            Groupchat_windows->setObjectName(QString::fromUtf8("Groupchat_windows"));
...
""));
        ...
        textEditWrite->setStyleSheet(QString::fromUtf8("border:none;\n"
"background-color: rgb(245,245,245);\n"
"left-margin: 10px;"));
        ...
        widget_3->setStyleSheet(QString::fromUtf8("background-color: rgb(245,245,245);"));
        ...
        emoji->setStyleSheet(QString::fromUtf8("QPushButton#emoji{\n"
"border:none;\n"
"}\n"
...
"}"));
        ...
        send_file->setStyleSheet(QString::fromUtf8("QPushButton#send_file{\n"
"border:none;\n"
"}\n"
...
"}"));
        ...
        prtsc->setObjectName(QString::fromUtf8("prtsc"));
        prtsc->setMinimumSize(QSize(50, 50));
        prtsc->setMaximumSize(QSize(50, 50));
        prtsc->setStyleSheet(QString::fromUtf8("border:none;"));
        ...
        history->setStyleSheet(QString::fromUtf8("QPushButton#history{\n"
"border:none;\n"
"}\n"
...
"}"));
        ...
        widget->setStyleSheet(QString::fromUtf8("QWidget#widget{background-color: rgb(245,245,245);}\n"
""));
...
"}"));
        ...
        listWidgetGroupNumbers->setObjectName(QString::fromUtf8("listWidgetGroupNumbers"));
        listWidgetGroupNumbers->setMinimumSize(QSize(200, 0));
        listWidgetGroupNumbers->setMaximumSize(QSize(200, 16777215));
        listWidgetGroupNumbers->setStyleSheet(QString::fromUtf8("border:none;\n"
"background-color: rgb(245,245,245);\n"
...
""));
    ...
    {
        Groupchat_windows->setWindowTitle(QApplication::translate("Groupchat_windows", "Form", nullptr));
        emoji->setText(QString());
        send_file->setText(QString());
        prtsc->setText(QString());
        history->setText(QString());
        pushButton->setText(QApplication::translate("Groupchat_windows", "\345\217\221\351\200\201", nullptr));
#ifndef QT_NO_SHORTCUT
        pushButton->setShortcut(QApplication::translate("Groupchat_windows", "Ctrl+S", nullptr));
