    ...
    ui(new Ui::Cell_Main)
{
    ...
    win_color = QString("#A5DEE4#51A8DD#2EA9DF");
    ...
    ChangeColor("#A5DEE4#51A8DD#2EA9DF");
...
void Cell_Main::ChangeColor(QString color)
{
    ...
    ui->side_bar->setStyleSheet("QWidget#side_bar{background-color:"+color_hard+";}");
    ui->main_widget->setStyleSheet("QWidget#main_widget{background-color:"+color_light+";}");
    ui->name_tag->setStyleSheet("QWidget#name_tag{background-color:"+color_medium+";}");
    ui->friend_2->setStyleSheet("QWidget#friend_2{background-color:"+color_medium+";}");
    if(cur_chat_fri != NULL)
    {
